...
TextStyle myhintTextstyle = TextStyle(
    height: 1.5,
    letterSpacing: 1,
...
var bigTitleStyle = TextStyle(
  ...
  color:
      Get.isDarkMode ? Colors.white.withOpacity(0.98) : const Color(0xff181b1f),
  overflow: TextOverflow.visible,
);

TextStyle onelineStyle = TextStyle(
    height: 1.5,
    color: Get.isDarkMode ? const Color(0xffA1a1aa) : const Color(0xff475569),
    fontSize: 20.sp,
    fontFamily: 'JosefinSans Regular');

TextStyle onpageheadingsyle = TextStyle(
  letterSpacing: 1,
  fontSize: 14.sp,
  color: Get.isDarkMode
...
TextStyle categoriesHeadingStyle = TextStyle(
    fontFamily: 'JosefinSans Bold',
    fontWeight: FontWeight.w500,
    color: Get.isDarkMode
...
TextStyle myParagraphStyle = TextStyle(
    height: 1.5,
    fontFamily: 'JosefinSans Regular',
    fontWeight: FontWeight.w500,
    color: Get.isDarkMode ? const Color(0xffa1a1aa) : const Color(0xff475569),
    fontSize: 17.sp);
TextStyle mediumHeadingStyle = TextStyle(
  fontSize: 20.sp,
  fontFamily: 'JosefinSans Bold',
  letterSpacing: 0.2,
  fontWeight: FontWeight.w500,
...
TextStyle popupHeadingStyle = TextStyle(
    fontSize: 13.sp,
    fontFamily: 'JosefinSans Medium',
    letterSpacing: 1,
    fontWeight: FontWeight.w400,
    color: Get.isDarkMode ? const Color(0xffFDFDF6) : const Color(0xff0A2647));
//==========================================================================================
...
// class Mycolors {
Color iconColor = Get.isDarkMode
    ? const Color.fromRGBO(122, 121, 121, 1)
    : const Color.fromRGBO(176, 179, 190, 1);
...
const webinarInfoTileGradient = LinearGradient(
